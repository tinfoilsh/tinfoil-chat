        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'wasm-unsafe-eval' https://plausible.io https://*.tinfoil.sh https://clerk.accounts.dev https://*.clerk.accounts.dev https://tinfoilsh.github.io https://vercel.live",
              "worker-src 'self'",
