...
/**
 * Parsed tool_call marker payload for code execution. Mirrors the
 * router's `tinfoil.tool_call` markers: `item_id`, `status`, and a
 * `tool` object carrying name, arguments (on in_progress), and output
...
/** Union of all tinfoil marker event types. */
