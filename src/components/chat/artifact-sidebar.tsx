...
export function ArtifactSidebar({
  ...
  // `inert` keeps the off-screen panel out of the tab order while still
  // allowing the slide-in transition. React 18 does not type the JSX
  // attribute so we toggle it imperatively.
  useEffect(() => {
