                    ...
                    <>
                      <div className="relative">
                        ...
                        >
                          ...
                          {(() => {
                            // The silence indicator below renders its own
                            // LoadingDots whenever the stream is quiet.
                            // Suppress the content-body tracer in that case
                            // so we don't stack two "still working" cues.
