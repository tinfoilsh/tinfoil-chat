...
const DefaultMessage = memo(
  ...
  (prevProps, nextProps) => {
    // Custom comparison to prevent unnecessary re-renders during thinking
    const { message: prevMessage } = prevProps
    const { message: nextMessage } = nextProps

    // For thinking messages, be very selective about re-renders
    if (prevMessage.isThinking || nextMessage.isThinking) {
      // Only re-render if actual content/thoughts changed
      return (
        prevMessage.content === nextMessage.content &&
        prevMessage.thoughts === nextMessage.thoughts &&
        prevMessage.isThinking === nextMessage.isThinking &&
        prevMessage.thinkingDuration === nextMessage.thinkingDuration &&
    ...
    // For regular messages, use normal comparison
    return (
