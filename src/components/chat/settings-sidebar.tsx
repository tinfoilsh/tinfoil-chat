  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed right-0 top-0 z-50 flex h-full w-[85vw] max-w-[${CONSTANTS.SETTINGS_SIDEBAR_WIDTH_PX}px] flex-col border-l ${
          isDarkMode
            ? 'border-gray-800 bg-gray-900'
            : 'border-gray-200 bg-white'
        } overflow-hidden md:w-[${CONSTANTS.SETTINGS_SIDEBAR_WIDTH_PX}px]`}
      >
        {/* Header */}
        <div
